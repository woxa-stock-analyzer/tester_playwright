...
//   test("Verify user sign up success with select profile pic", async ({
//     page,
//   }) => {
...
//     });
//   });
//   test("Verify user sign up success with no select profile pic", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//       signUp.valid_user_no_select_profile.confirm_password;
...
//       await expect(signupPage.displayProfileNoPic(display_name)).toHaveText(
//         firstChar,
//       );
//     });
//   });

//   test("Verify user sign up success with number in display name", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.valid_user_display_name_number.confirm_password;
...
//   test("Verify user sign up success with display name have _", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.valid_user_display_name_underscore.confirm_password;
...
//   test("Verify user click eye icon at  password field to see password.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//       await expect(signupPage.confirmPasswordField).toHaveAttribute(
//         "type",
//         "text",
//       );
//     });
...
//   test("Verify user sign up failed with invalid email format.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//       await expect(signupPage.displayEmailError()).toContainText(
...
//   test("Verify user sign up failed with invalid password least than 8 characters.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_password_least_than_8.confirm_password;
...
//       await expect(signupPage.displayPasswordLengthRequirement()).toContainText(
//         "Must be at least 8 characters long",
//       );
//       await expect(signupPage.displayPasswordLengthRequirement()).toHaveClass(
//         "text-[12px] font-normal text-error-500",
//       );
//     });
//   });

//   test("Verify user sign up failed with password don’t have letter.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_password_no_have_letter.confirm_password;
...
//     await test.step("Expect display password error message", async () => {
//       await expect(signupPage.displayPasswordError()).toContainText("Invalid");
//       await expect(signupPage.displayPasswordLetterRequirement()).toContainText(
//         "Must contain (A-Z or a-z)",
//       );
//       await expect(signupPage.displayPasswordLetterRequirement()).toHaveClass(
//         "text-[12px] font-normal text-error-500",
//       );
//     });
//   });

//   test("Verify user sign up failed with password don’t have numberic.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_password_no_have_number.confirm_password;
//     // go to https://stockanalyzer.adenxus.com/markets
//     await test.step("Go to markets page", async () => {
//       await page.goto("https://stockanalyzer.adenxus.com/markets");
//     });
...
//     await test.step("Expect display password error message", async () => {
//       await expect(signupPage.displayPasswordError()).toContainText("Invalid");
//       await expect(signupPage.displayPasswordNumberRequirement()).toContainText(
//         "Must contain at least 1 number (0-9)",
//       );
//       await expect(signupPage.displayPasswordNumberRequirement()).toHaveClass(
//         "text-[12px] font-normal text-error-500",
//       );
//     });
//   });

//   test("Verify user sign up failed with password have special character.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_password_have_special_character.confirm_password;
//     // go to https://stockanalyzer.adenxus.com/markets
//     await test.step("Go to markets page", async () => {
//       await page.goto("https://stockanalyzer.adenxus.com/markets");
//     });
...
//     await test.step("Expect display password error message", async () => {
//       await expect(signupPage.displayPasswordError()).toContainText("Invalid");
//       await expect(signupPage.displayPasswordSpecialCharError()).toContainText(
//         "Must not contain special characters (!@#$%^&*)",
//       );
//       await expect(signupPage.displayPasswordSpecialCharError()).toHaveClass(
//         "text-[12px] font-normal text-error-500",
//       );
//     });
//   });

//   test("Verify user sign up failed with confirm password mismatch.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_confirm_password_not_match.confirm_password;
//     // go to https://stockanalyzer.adenxus.com/markets
//     await test.step("Go to markets page", async () => {
//       await page.goto("https://stockanalyzer.adenxus.com/markets");
//     });
...
//       await expect(signupPage.displayConfirmPasswordError()).toContainText(
//         "Passwords do not match.",
//       );
//     });
//   });
//   test("Verify user sign up failed with confirm password empty field.", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_confirm_password_empty.confirm_password;
//     // go to https://stockanalyzer.adenxus.com/markets
//     await test.step("Go to markets page", async () => {
//       await page.goto("https://stockanalyzer.adenxus.com/markets");
//     });
...
//     await test.step("Expect display password error message", async () => {
//       await expect(signupPage.displayPasswordError()).toContainText(
...
//   test("Verify user sign up success with display name no english language", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//       await expect(signupPage.displayDisplayNameEngRequirement()).toContainText(
//         "English language only.",
//       );
//       await expect(signupPage.displayDisplayNameEngRequirement()).toHaveClass(
//         "text-[12px] font-normal text-red-500",
//       );
//     });
//   });

//   test("Verify user sign up success with display name less than 5 characters", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     await test.step("Expect display display name error message", async () => {
//       await expect(
//         signupPage.displayDisplayNameMinLengthRequirement(),
//       ).toContainText("Must be at least 5 characters long");
//       await expect(
//         signupPage.displayDisplayNameMinLengthRequirement(),
//       ).toHaveClass("text-[12px] font-normal text-red-500");
//     });
//   });

//   test("Verify user sign up success with display name have special characters", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
...
//     const confirm_password =
//       signUp.invalid_name_have_special_characters.confirm_password;
//     const display_name =
//       signUp.invalid_name_have_special_characters.display_name;
...
//     await test.step("Expect display display name error message", async () => {
//       await expect(
//         signupPage.displayDisplayNameSpecialCharError(),
//       ).toContainText("Must not contain special characters (!@#$%^&*)");
//       await expect(signupPage.displayDisplayNameSpecialCharError()).toHaveClass(
//         "text-[12px] font-normal text-red-500",
//       );
//     });
//   });

//   test("Verify user sign up success with display name empty", async ({
//     page,
//   }) => {
//     const signupPage = new SignUpPage(page);
